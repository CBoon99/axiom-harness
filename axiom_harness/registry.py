...
REGISTRY = {
    ...
    "per": {"path": "Axiom Evidence Layer/PER-Core", "gate": "|R|<=3 OR weight>=75 OR ent>=4, ΔH>0.5", "mode": "OFF in V1"},
    "eca": {"path": "Axiom Evidence Layer/ECA", "gate": "GateOk |R|<=3 && ΔH>0.5 && sealed+hash && FALSIFY", "mode": "OFF in V1"},
